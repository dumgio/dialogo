...
export const TEMI = [
  ...
  'Natura', 'Educazione', 'Bellezza', 'Amore', 'Potere',
];
...
export const DOMANDE = [
  ...
  { id: 23, tema: 'Identità', pubblico: 'scuola', testo: "Siamo la stessa persona con gli amici e in famiglia?" },
  { id: 24, tema: 'Identità', pubblico: 'scuola', testo: "Il nome che portiamo ci definisce?" },
  { id: 25, tema: 'Identità', pubblico: 'adulti', testo: "Quanto di ciò che siamo dipende dal ruolo che svolgiamo?" },
  { id: 26, tema: 'Identità', pubblico: 'adulti', testo: "Si può diventare qualcun altro senza tradire se stessi?" },
  { id: 27, tema: 'Identità', pubblico: 'tutti', testo: "Che cosa resta di noi quando tutto cambia?" },
  { id: 28, tema: 'Giustizia', pubblico: 'scuola', testo: "È giusto punire chi sbaglia, o è meglio aiutarlo a capire?" },
  { id: 29, tema: 'Giustizia', pubblico: 'scuola', testo: "Se nessuno guarda, ha ancora senso essere onesti?" },
  { id: 30, tema: 'Giustizia', pubblico: 'adulti', testo: "La legge e la giustizia coincidono sempre?" },
  { id: 31, tema: 'Giustizia', pubblico: 'adulti', testo: "Perdonare è un atto di giustizia o una rinuncia?" },
  { id: 32, tema: 'Giustizia', pubblico: 'tutti', testo: "È giusto che chi ha di più aiuti chi ha meno?" },
  { id: 33, tema: 'Verità', pubblico: 'scuola', testo: "Una bugia a fin di bene è sempre sbagliata?" },
  { id: 34, tema: 'Verità', pubblico: 'scuola', testo: "Come facciamo a sapere che una notizia è vera?" },
  { id: 35, tema: 'Verità', pubblico: 'adulti', testo: "Si può convivere con verità diverse?" },
  { id: 36, tema: 'Verità', pubblico: 'adulti', testo: "È meglio una verità dolorosa o una bugia consolante?" },
  { id: 37, tema: 'Verità', pubblico: 'tutti', testo: "Chi decide che cosa è vero?" },
  { id: 38, tema: 'Felicità', pubblico: 'scuola', testo: "Si può essere felici da soli?" },
  { id: 39, tema: 'Felicità', pubblico: 'scuola', testo: "Avere tante cose ci rende più felici?" },
  { id: 40, tema: 'Felicità', pubblico: 'adulti', testo: "La felicità è uno scopo della vita o un effetto collaterale?" },
  { id: 41, tema: 'Felicità', pubblico: 'adulti', testo: "Si può essere felici quando gli altri soffrono?" },
  { id: 42, tema: 'Felicità', pubblico: 'tutti', testo: "Quali piccole cose ci rendono felici, e perché?" },
  { id: 43, tema: 'Diversità', pubblico: 'scuola', testo: "Le persone diverse da noi ci fanno paura o ci incuriosiscono?" },
  { id: 44, tema: 'Diversità', pubblico: 'scuola', testo: "Che cosa vuol dire sentirsi accolti?" },
  { id: 45, tema: 'Diversità', pubblico: 'adulti', testo: "Come si convive con chi ha valori diversi dai nostri?" },
  { id: 46, tema: 'Diversità', pubblico: 'adulti', testo: "L'uguaglianza cancella le differenze o le protegge?" },
  { id: 47, tema: 'Diversità', pubblico: 'tutti', testo: "Una comunità ha bisogno di persone diverse?" },
  { id: 48, tema: 'Tecnologia', pubblico: 'scuola', testo: "Potremmo vivere una settimana senza telefono? Che cosa cambierebbe?" },
  { id: 49, tema: 'Tecnologia', pubblico: 'scuola', testo: "Un'amicizia online è un'amicizia vera?" },
  { id: 50, tema: 'Tecnologia', pubblico: 'adulti', testo: "La tecnologia ci rende più liberi o più controllati?" },
  { id: 51, tema: 'Tecnologia', pubblico: 'adulti', testo: "Affidare le decisioni alle macchine ci toglie responsabilità?" },
  { id: 52, tema: 'Tecnologia', pubblico: 'tutti', testo: "Ciò che si può fare con la tecnologia è anche giusto farlo?" },
  { id: 53, tema: 'Tempo', pubblico: 'scuola', testo: "Perché il tempo sembra passare più in fretta quando ci divertiamo?" },
  { id: 54, tema: 'Tempo', pubblico: 'scuola', testo: "Il futuro dipende da noi o è già scritto?" },
  { id: 55, tema: 'Tempo', pubblico: 'adulti', testo: "Che cosa vuol dire perdere tempo?" },
  { id: 56, tema: 'Tempo', pubblico: 'adulti', testo: "La fretta è un problema solo del nostro tempo?" },
  { id: 57, tema: 'Tempo', pubblico: 'tutti', testo: "Il valore delle cose cambia con il passare degli anni?" },
  { id: 58, tema: 'Responsabilità', pubblico: 'scuola', testo: "Se faccio una cosa perché me l'hanno ordinata, di chi è la colpa?" },
  { id: 59, tema: 'Responsabilità', pubblico: 'scuola', testo: "Siamo responsabili anche di ciò che non facciamo?" },
  { id: 60, tema: 'Responsabilità', pubblico: 'adulti', testo: "Quanto siamo responsabili di chi dipende da noi?" },
  { id: 61, tema: 'Responsabilità', pubblico: 'adulti', testo: "Che cosa dobbiamo alle generazioni future?" },
  { id: 62, tema: 'Responsabilità', pubblico: 'tutti', testo: "Si può essere responsabili senza avere colpa?" },
  { id: 63, tema: 'Linguaggio', pubblico: 'scuola', testo: "Le parole possono far male quanto i gesti?" },
  { id: 64, tema: 'Linguaggio', pubblico: 'scuola', testo: "Esistono cose che non si possono dire con le parole?" },
  { id: 65, tema: 'Linguaggio', pubblico: 'adulti', testo: "Chi controlla le parole controlla anche il pensiero?" },
  { id: 66, tema: 'Linguaggio', pubblico: 'adulti', testo: "Il silenzio è una forma di linguaggio?" },
  { id: 67, tema: 'Linguaggio', pubblico: 'tutti', testo: "Parlare la stessa lingua vuol dire capirsi?" },
  { id: 68, tema: 'Senso', pubblico: 'scuola', testo: "Che cosa dà senso a una giornata?" },
  { id: 69, tema: 'Senso', pubblico: 'scuola', testo: "Che cosa ci fa alzare la mattina?" },
  { id: 70, tema: 'Senso', pubblico: 'adulti', testo: "Il senso della vita si trova o si costruisce?" },
  { id: 71, tema: 'Senso', pubblico: 'adulti', testo: "Si può vivere bene senza chiedersi il perché?" },
  { id: 72, tema: 'Senso', pubblico: 'tutti', testo: "Che cosa vorremmo lasciare agli altri?" },
  { id: 73, tema: 'Amicizia', pubblico: 'scuola', testo: "Si può essere amici di chi la pensa in modo opposto?" },
  { id: 74, tema: 'Amicizia', pubblico: 'scuola', testo: "Che cosa vuol dire essere leali?" },
  { id: 75, tema: 'Amicizia', pubblico: 'adulti', testo: "Un'amicizia può finire senza che nessuno abbia colpa?" },
  { id: 76, tema: 'Amicizia', pubblico: 'adulti', testo: "L'amicizia è un dovere o un dono?" },
  { id: 77, tema: 'Amicizia', pubblico: 'tutti', testo: "Che cosa cerchiamo negli amici?" },
  { id: 78, tema: 'Regole', pubblico: 'scuola', testo: "Una regola ingiusta va rispettata?" },
  { id: 79, tema: 'Regole', pubblico: 'scuola', testo: "Chi fa le regole dovrebbe rispettarle per primo?" },
  { id: 80, tema: 'Regole', pubblico: 'adulti', testo: "Quando è giusto disobbedire?" },
  { id: 81, tema: 'Regole', pubblico: 'adulti', testo: "Servono più regole o più fiducia?" },
  { id: 82, tema: 'Regole', pubblico: 'tutti', testo: "Che cosa succederebbe in un mondo senza regole?" },
  { id: 83, tema: 'Coraggio', pubblico: 'scuola', testo: "Dire di no agli amici richiede coraggio?" },
  { id: 84, tema: 'Coraggio', pubblico: 'scuola', testo: "Si può essere coraggiosi senza essere forti?" },
  { id: 85, tema: 'Coraggio', pubblico: 'adulti', testo: "Serve più coraggio per restare o per andarsene?" },
  { id: 86, tema: 'Coraggio', pubblico: 'adulti', testo: "Dire la verità richiede sempre coraggio?" },
  { id: 87, tema: 'Coraggio', pubblico: 'tutti', testo: "Qual è la differenza tra coraggio e incoscienza?" },
  { id: 88, tema: 'Lavoro', pubblico: 'scuola', testo: "Che lavoro vorremmo fare, e che cosa ci fa scegliere proprio quello?" },
  { id: 89, tema: 'Lavoro', pubblico: 'scuola', testo: "Tutti i lavori hanno la stessa dignità?" },
  { id: 90, tema: 'Lavoro', pubblico: 'adulti', testo: "Siamo ciò che facciamo per lavoro?" },
  { id: 91, tema: 'Lavoro', pubblico: 'adulti', testo: "Il tempo libero è un diritto o un premio?" },
  { id: 92, tema: 'Lavoro', pubblico: 'tutti', testo: "Lavorare tanto è sempre una virtù?" },
  { id: 93, tema: 'Libertà', pubblico: 'scuola', testo: "Essere liberi vuol dire fare quello che si vuole?" },
  { id: 94, tema: 'Libertà', pubblico: 'scuola', testo: "La libertà di uno finisce dove comincia quella degli altri?" },
  { id: 95, tema: 'Libertà', pubblico: 'adulti', testo: "Si può essere liberi e dipendere da qualcuno?" },
  { id: 96, tema: 'Libertà', pubblico: 'adulti', testo: "Abbiamo paura della libertà?" },
  { id: 97, tema: 'Libertà', pubblico: 'tutti', testo: "Che cosa siamo disposti a lasciare per essere liberi?" },
  { id: 98, tema: 'Cura', pubblico: 'scuola', testo: "Che cosa vuol dire prendersi cura di qualcuno?" },
  { id: 99, tema: 'Cura', pubblico: 'scuola', testo: "Si può voler bene a qualcuno senza dirglielo mai?" },
  { id: 100, tema: 'Cura', pubblico: 'adulti', testo: "Chi si prende cura degli altri ha bisogno di essere curato?" },
  { id: 101, tema: 'Cura', pubblico: 'adulti', testo: "Curare vuol dire guarire?" },
  { id: 102, tema: 'Cura', pubblico: 'tutti', testo: "Ci si può prendere cura di sé senza essere egoisti?" },
  { id: 103, tema: 'Fiducia', pubblico: 'scuola', testo: "Si può ricominciare a fidarsi dopo una delusione?" },
  { id: 104, tema: 'Fiducia', pubblico: 'scuola', testo: "Perché a volte non riusciamo a fidarci nemmeno di chi ci vuole bene?" },
  { id: 105, tema: 'Fiducia', pubblico: 'adulti', testo: "La fiducia va data subito o va guadagnata?" },
  { id: 106, tema: 'Fiducia', pubblico: 'adulti', testo: "Fidarsi è un rischio o una scelta?" },
  { id: 107, tema: 'Fiducia', pubblico: 'tutti', testo: "Che cosa succede a una comunità quando manca la fiducia?" },
  { id: 108, tema: 'Natura', pubblico: 'tutti', testo: "Siamo parte della natura o siamo qualcosa di diverso?" },
  { id: 109, tema: 'Natura', pubblico: 'scuola', testo: "Gli animali hanno dei diritti?" },
  { id: 110, tema: 'Natura', pubblico: 'scuola', testo: "Perché ci sentiamo bene in mezzo alla natura?" },
  { id: 111, tema: 'Natura', pubblico: 'adulti', testo: "Abbiamo il diritto di usare la natura per i nostri bisogni?" },
  { id: 112, tema: 'Natura', pubblico: 'adulti', testo: "Quanto siamo disposti a cambiare vita per proteggere l'ambiente?" },
  { id: 113, tema: 'Natura', pubblico: 'tutti', testo: "Che mondo lasceremo a chi verrà dopo di noi?" },
  { id: 114, tema: 'Educazione', pubblico: 'tutti', testo: "Che cosa vuol dire imparare?" },
  { id: 115, tema: 'Educazione', pubblico: 'scuola', testo: "A che cosa serve la scuola, oltre a studiare?" },
  { id: 116, tema: 'Educazione', pubblico: 'scuola', testo: "Sbagliare aiuta a imparare?" },
  { id: 117, tema: 'Educazione', pubblico: 'adulti', testo: "Educare è insegnare a obbedire o a pensare?" },
  { id: 118, tema: 'Educazione', pubblico: 'adulti', testo: "Chi educa gli educatori?" },
  { id: 119, tema: 'Educazione', pubblico: 'tutti', testo: "Si finisce mai di imparare?" },
  { id: 120, tema: 'Bellezza', pubblico: 'tutti', testo: "La bellezza è negli occhi di chi guarda o esiste anche senza di noi?" },
  { id: 121, tema: 'Bellezza', pubblico: 'scuola', testo: "Perché ci piacciono alcune cose e altre no?" },
  { id: 122, tema: 'Bellezza', pubblico: 'scuola', testo: "Essere belli conta più di essere bravi?" },
  { id: 123, tema: 'Bellezza', pubblico: 'adulti', testo: "L'arte deve servire a qualcosa?" },
  { id: 124, tema: 'Bellezza', pubblico: 'adulti', testo: "La bellezza è un lusso o un bisogno?" },
  { id: 125, tema: 'Bellezza', pubblico: 'tutti', testo: "Che cosa rende bello un gesto?" },
  { id: 126, tema: 'Amore', pubblico: 'tutti', testo: "Si può amare senza possedere?" },
  { id: 127, tema: 'Amore', pubblico: 'scuola', testo: "Come si capisce se ci si vuole davvero bene?" },
  { id: 128, tema: 'Amore', pubblico: 'scuola', testo: "Amare vuol dire accettare l'altro com'è?" },
  { id: 129, tema: 'Amore', pubblico: 'adulti', testo: "L'amore dura per scelta o per caso?" },
  { id: 130, tema: 'Amore', pubblico: 'adulti', testo: "Ci si può amare senza conoscersi davvero?" },
  { id: 131, tema: 'Amore', pubblico: 'tutti', testo: "Amare gli altri comincia dall'amare se stessi?" },
  { id: 132, tema: 'Potere', pubblico: 'tutti', testo: "Chi ha potere ha anche più responsabilità?" },
  { id: 133, tema: 'Potere', pubblico: 'scuola', testo: "Perché a volte ci piace comandare?" },
  { id: 134, tema: 'Potere', pubblico: 'scuola', testo: "Un capo deve essere obbedito o deve convincere?" },
...
export const PAGINE = [
  {
    ...
    blocchi: [
      ...
      { t: 'lista', x: [
        `**Durata:** 60, 90 o 120 minuti, oppure «Su misura» (da 30 a 240 minuti, vedi più sotto). L'app adatta il tempo di ogni fase.`,
        ...
        `**La domanda:** scegli una delle tre proposte, tocca «Sorprendimi» o «Altre tre», apri l'elenco con «Sfoglia tutte le domande», oppure scrivi la tua.`,
        `**Suono di avviso:** spento o acceso. Un breve suono a fine fase, in più della vibrazione.`,
      ...
      { t: 'p', x: `Se hai acceso il **suono di avviso**, a fine fase, a fine silenzio e a fine intervento senti un breve suono. È utile soprattutto sugli iPhone, che non vibrano.` },
      ...
      { t: 'lista', x: [
        ...
        `**Sfoglia tutte le domande:** apre un elenco a tendina per argomento, con la ricerca e il filtro per scuola o adulti. Scegli una domanda con un tocco.`,
      ...
      { t: 'lista', x: [
        ...
        `**Suono di avviso:** lo accendi o lo spegni anche durante l'incontro.`,
      ] },
      ...
      { t: 'h', x: 'Riprendere un incontro' },
      { t: 'p', x: `Se chiudi l'app per sbaglio, o il telefono la chiude da solo, alla riapertura trovi «Hai un incontro in corso» con i pulsanti «Riprendi» e «Scarta». Il tempo riparte dall'orologio, quindi è giusto anche dopo qualche minuto. I nomi dei turni non si salvano: dovrai riscriverli. L'incontro salvato si cancella quando lo concludi e comunque dopo 8 ore.` },
      ...
      { t: 'h', x: 'Privacy' },
      { t: 'p', x: `Dialogo non ha account, non ha pubblicità e non raccoglie dati. Sul telefono restano solo le tue ultime scelte (durata, gruppo, luogo, pubblico e suono) e, durante un incontro, il suo stato (fase, tempi e domanda, senza nomi) per poterlo riprendere: si cancella a fine incontro. La scheda di riflessione non viene salvata: la copi tu dove vuoi.` },
      ...
      { t: 'lista', x: [
        ...
        `**Il telefono non vibra.** Non tutti i telefoni lo permettono (per esempio gli iPhone). Accendi il suono di avviso, oppure guarda il numero del tempo: diventa rosso e mostra il segno «+».`,
        `**Ho chiuso l'app durante un incontro.** Riaprila: trovi «Hai un incontro in corso» e tocchi «Riprendi». I nomi dei turni non si salvano.`,
  ...
  },
  {
    ...
    blocchi: [
      { t: 'p', x: `Sfoglia le domande per argomento: tocca un argomento per aprirlo. Le prime dieci domande sono quelle del kit di Formebrevi, le altre sono state scritte per questa app. Puoi cercare una parola e scegliere le domande per la scuola o per gli adulti.` },
      { t: 'domande' },
